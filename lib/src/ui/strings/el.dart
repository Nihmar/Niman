...
final class GreekStrings extends Strings {
  ...
  String get paletteFooterTouch =>
      'Πατήστε για χρήση · η πινέζα το κρατά επάνω';
  @override
  ...
  String get libraryForgetOpenExplained =>
      'Αυτή η βιβλιοθήκη είναι ανοιχτή τώρα: κλείνει πρώτα και μετά φεύγει '
      'από τη λίστα. Ο φάκελος, οι σημειώσεις και οι ρυθμίσεις της '
      'βιβλιοθήκης μέσα της μένουν ανέπαφα, και το άνοιγμά της ξανά τη '
      'φέρνει πίσω.';
